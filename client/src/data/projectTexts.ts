...
It's built with TypeScript and the VSCode SDK, and I use it on every project that touches CSS Modules. There's still room to grow it, but it solves the problem it was built for, which is the point.`,
  ...
  chop: {
    ...
    long: `Digging for tracks in DJ mixes is a pain. You hear something, you don't know what it is, and unless the DJ bothered to post a tracklist (which they rarely do), you're on your own. chop is my attempt to fix that.
